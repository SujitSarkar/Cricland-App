...
class _MorePageState extends State<MorePage> {
  ...
  Widget _bodyUI(BuildContext context) => ListView(
        ...
        children: [
          ...
          ///Settings
          Text('Settings', style: MorePage._titleStyle),
          ...
          ///Premium
          Text('PREMIUM', style: MorePage._titleStyle),
          SizedBox(height: dSize(.02)),
          MoreCard(
            child: CardTile(
                leadingIcon: FontAwesomeIcons.language,
          ...
          ///Visit
          Text('Visit', style: MorePage._titleStyle),
          SizedBox(height: dSize(.02)),
          MoreCard(
            child: Column(
              children: [
          ...
          ///Support
          Text('Support', style: MorePage._titleStyle),
          SizedBox(height: dSize(.02)),
          MoreCard(
            child: Column(
              children: [
          ...
          ///About
          Text('About', style: MorePage._titleStyle),
          SizedBox(height: dSize(.02)),
          MoreCard(
            child: Column(
              children: [
                        ...
                        children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: PublicController.pc
                                    .toggleTextColor(), // red as border color
                              ),
                            ...
                            child: ListTile(
                              ...
                              trailing: Icon(
                                Icons.check_circle,
                                color: PublicController.pc.toggleStatusBar(),
                              ),
                              selected: true,
                              selectedTileColor:
